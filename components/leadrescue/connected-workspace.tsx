...
type Lead={id:string;name:string;source:string;currentState:string;leadScore:number|null;rescueRisk:number|null;progressionScore:number|null;rescuePriority:number|null;doNotContact:boolean;humanRequired:boolean};
...
export default function ConnectedWorkspace({signedIn,displayName,signInPath,signOutPath}:{signedIn:boolean;displayName:string;signInPath:string;signOutPath:string}){
  ...
  return <main className="min-h-screen bg-background text-foreground">
    ...
    <section className="max-w-6xl mx-auto p-6 md:p-10 space-y-6">
      {signedIn&&<a href="/importar" className="inline-block rounded-lg border bg-card px-5 py-3 font-medium text-primary">Preparar CSV de leads</a>}
